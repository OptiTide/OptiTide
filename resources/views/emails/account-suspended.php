...
<p style="margin:0 0 18px;line-height:1.6;">We've had to place your <?= e(config('company.legal_name', 'OptiTide')) ?> account <strong>on hold</strong> because one or more invoices have remained unpaid past their due date. Your services have been paused for now.</p>
