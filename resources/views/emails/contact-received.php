...
<p style="margin:0 0 18px;line-height:1.6;">Thanks for reaching out to <?= e(config('company.brand_name')) ?> — we've received your enquiry and one of our team will get back to you shortly, usually within one business day.</p>
...
<p style="margin:16px 0 0;color:#64748b;font-size:13px;line-height:1.6;">Talk soon,<br>The <?= e(config('company.brand_name')) ?> Team</p>
<?php $this->endSection(); ?>
