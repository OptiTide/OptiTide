...
<p style="margin:0 0 18px;line-height:1.6;">
    <?php if ($isResend): ?>
        Here's a fresh link to your <?= e(config('company.brand_name')) ?> client portal<?= $business ? ' for ' . e($business) : '' ?> — the previous one has been replaced.
    <?php else: ?>
        Welcome aboard! Your <?= e(config('company.brand_name')) ?> client portal<?= $business ? ' for ' . e($business) : '' ?> is set up and ready.
    <?php endif; ?>
