...
<p style="margin:0 0 18px;line-height:1.6;">This is a friendly reminder that invoice <strong><?= e($invoice['number']) ?></strong> was due on <strong><?= e($invoice['due_date']) ?></strong> and is now overdue.</p>
...
<table role="presentation" width="100%" style="margin:8px 0 20px;border-collapse:collapse;">
    ...
    <tr><td style="padding:6px 0;color:#64748b;">Due date</td><td style="padding:6px 0;text-align:right;"><?= e($invoice['due_date']) ?></td></tr>
...
<p style="margin:0;color:#64748b;font-size:13px;line-height:1.6;">If you've already paid, please ignore this reminder. If you have any questions about this invoice, just reply and we'll be glad to help.</p>
<?php $this->endSection(); ?>
