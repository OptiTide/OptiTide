...
<div class="row justify-content-center"><div class="col-lg-9">
    ...
    <h2 class="h5 fw-bold mt-4">5. Cookies &amp; Analytics</h2>
    <p>Our website may use cookies and analytics tools to understand how it is used and to improve it. You can control cookies through your browser settings.</p>
