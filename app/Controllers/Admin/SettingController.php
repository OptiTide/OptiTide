...
class SettingController extends Controller
{
    ...
    protected const EDITABLE = [
        ...
        's_skrill_email'  => 'payments.gateways.skrill.merchant_email',
        's_paypal_handle' => 'payments.gateways.paypal.me_handle',
        's_ga4'           => 'analytics.ga4',
        's_gtm'           => 'analytics.gtm',
        's_gsc'           => 'analytics.gsc',
    ...
    public function edit(Request $request): Response
    {
        ...
        return $this->view('admin.settings.edit', [
            ...
            'skrill'   => config('payments.gateways.skrill'),
            'paypal'   => config('payments.gateways.paypal'),
    ...
    public function update(Request $request): Response
    {
        ...
        $this->validate($request, [
            ...
            's_hours'               => 'nullable|max:80',
            's_social_fb'           => 'nullable|max:200',
            's_social_ig'           => 'nullable|max:200',
            's_social_li'           => 'nullable|max:200',
            's_payid_type'          => 'nullable|in:mobile,email,abn',
            's_payoneer_mode'       => 'nullable|in:manual,api',
            's_skrill_email'        => 'nullable|email|max:180',
            's_paypal_handle'       => 'nullable|max:60',
